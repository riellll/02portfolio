...
const Hero = () => {
  return (
    <div className="grid bg-white h-screen gap-4 sm:mt-0 sm:mb-2 content-center justify-items-center text-center dark:bg-gradient-to-r dark:from-gray-800 dark:to-slate-900 md:px-32 sm:px-12 min-[320px]:px-6 min-[320px]:mb-40 min-[320px]:mt-10">
