...
const Hero = () => {
  return (
    <div className="grid bg-white h-screen gap-4 sm:mt-0 sm:mb-10 content-center justify-items-center text-center md:px-32 sm:px-12 min-[320px]:px-6 min-[320px]:mb-40 min-[320px]:mt-28">
