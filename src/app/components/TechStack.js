...
const TechStack = () => {
  return (
    <div className="flex flex-col gap-4 text-center md:px-18 sm:px-12">
      ...
      <div className="flex flex-wrap justify-center place-items-center gap-5 border-b-2 border-b-gray-600 dark:border-b-cyan-800 text-black min-[320px]:px-6">
        ...
        <Image src={nextjsLogo} alt="nextjs" width={500} height={500} className="w-10 h-auto" priority />
        <Image src={expressLogo} alt="ex" width={1000} height={1000} className="w-16 h-auto" priority />
